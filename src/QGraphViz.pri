...
!isEmpty(QGV_PRI_INCLUDED): error("QGraphViz.pri already included")
QGV_PRI_INCLUDED = 1
...
# INCLUDE PATHS #
#################
INCLUDEPATH       += $$quote($${SOURCE_PATH}) $$quote($${SOURCE_PATH}/lib)
DEPENDPATH        += $$quote($${SOURCE_PATH}) $$quote($${SOURCE_PATH}/lib)
